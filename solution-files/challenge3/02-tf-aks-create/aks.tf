...
resource "azurerm_kubernetes_cluster" "aks" {
  ...
  #api_server_authorized_ip_ranges   = concat([data.azurerm_public_ip.fw-pip.ip_address], var.api_auth_ips)
  /*
  linux_profile {
...
*/
  default_node_pool {
    ...
    vnet_subnet_id      = var.aks_configuration["aks_worker_subnet_id"]
